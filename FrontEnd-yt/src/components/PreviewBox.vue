<template>
    <div style="display: flex; flex-direction: column">
        <div style="width: 100%; padding-bottom: 10px; margin-bottom: 0px; text-align: left;">
            <div style="margin-bottom: 14px"><span style="color: #333333; font-size: 22px; font-family: 'Roboto-medium'">{{transformString(solutions.filter(({ _id }) => survey.solutionId)[0].category)}} • {{transformString(survey.description)}}</span></div>
            <div><span style="color: #333333; font-size: 18px; font-family: 'Roboto-regular'">{{survey.question}}</span></div>
        </div>
        <div style="width: 100%;height: 100%;margin-bottom: 30px;padding: 24px 14px 20px 22px; background: white;display: flex;flex-direction: column;border: 1px solid #cecece;border-radius: 3px;">
            <div style="width: 100%; display: flex; align-items: center; justify-content: space-between;border-bottom: 1px solid #ececec; padding-bottom: 7px; margin-bottom: 16px;">
                <div><span style="font-family: 'Roboto-regular'; color: #555555; font-size: 14px">Opciones</span></div>
                <div style="display: flex; align-items: center; margin-right: 294px">
                    <div style="width: 10px; height: 10px; background: #3367d6; margin-right: 10px;"></div>
                    <span style="color: #555555; font-family: 'Roboto-regular'; font-size: 14px">Validaciones Totales</span>
                </div>
            </div>
            <div style="width: 300px; margin-right: 335px; margin-left: 62px;">
                <dl>
                    <div v-for="(option, i) in survey.options.filter(({ active }) => active)" :key="i">
                        <div>
                            <span class="text" style="width: 290px;font-family: 'Roboto-regular'; margin-top: 10px;font-size: 15px;color: #111111;">{{option.optionDescription}}</span>
                        </div>
            ...
            <div style="margin-top: 42px"><span style="font-size: 14px; font-family: 'Roboto-regular'; color: #555555">Otras validaciones de clientes</span></div>
